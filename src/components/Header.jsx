...
const Header = () =>{
    return(
        <div className="max-w-[1640px] px-4 pt-0 pb-4 mx-auto">
            <div className="w-full flex flex-col items-center p-0 my-12">
            ...
            <p className='mt-5 font-semibold text-gray-600 text-lg sm:text-2xl md:text-3xl lg:text-4xl'>avoid the threats waiting for you on the Internet, be less noticeable.</p>
