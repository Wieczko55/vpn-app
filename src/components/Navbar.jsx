    ...
    return(
        <div className="flex justify-between max-w-[1640px] p-3.5 mx-auto border-b border-slate-300 overflow-hidden">
           ...
           <div className="flex items-center sm:*:mx-2 md:*:mx-2 lg:*:mx-3 hover:*:text-blue-500">
                <a href="#" className="hidden md:block">Price</a>
                <a href="#" className="hidden md:block">Functions</a>
                <a href="#" className="hidden md:block">Servers</a>
                <a href="#" className="hidden md:block">Download</a>
                <a href="#" className="hidden lg:block">Blog</a>
                <a href="" className="hidden lg:block">For companies</a>
           </div>
           <div className="flex items-center  sm:ml-0 sm:*:mx-1.3 lg:*:m-3 md:*:mx-3">
                ...
                <a href="#" className="hover:text-blue-500 text-sm sm:text-md ml-2.5">Log in</a>
                <a href="#" className="sm:block hidden hover:text-blue-500 text-sm sm:text-md ml-1.5">Help</a>
                ...
                <div className={' overflow-y-auto fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300'} style={{left: nav? '-9999px' : ''}}>
                    ...
                    <nav>
                        <ul className='flex flex-col py-4 text-gray-800'>
                            <li className='cursor-poinnter flex py-4 text-xl first:pt-2 border-y hover:bg-slate-200 w-full'><TbTruckDelivery size={25} className='mr-4 ml-3'/>Orders</li>
                            <li className='cursor-poinnter flex py-4 text-xl border-y hover:bg-slate-200'><MdFavorite size={25} className='mr-4 ml-3'/>Favourites</li>
                            <li className='cursor-poinnter flex py-4 text-xl border-y hover:bg-slate-200'><FaWallet size={25} className='mr-4 ml-3'/>Wallet</li>
                            <li className='cursor-poinnter flex py-4 text-xl border-y hover:bg-slate-200'><IoMdHelp  size={25} className='mr-4 ml-3'/>Help</li>
                            <li className='cursor-poinnter flex py-4 text-xl border-y hover:bg-slate-200'><AiFillTag size={25} className='mr-4 ml-3'/>Promotions</li>
                            <li className='cursor-poinnter flex py-4 text-xl border-y hover:bg-slate-200'><BsFillSaveFill size={25} className='mr-4 ml-3'/>Best Ones</li>
                            <li className='cursor-poinnter flex py-4 text-xl last:pb-2 border-y hover:bg-slate-200'><FaUserFriends size={25} className='mr-4 ml-3'/>Invite Friends</li>
                        </ul>
                    </nav>
