const User = () =>{
    return(
        <div className="max-w-[1640px] mx-auto p-4 lg:mt-10 lg:grid lg:grid-cols-2 sm:flex sm:flex-col sm:items-center mt-10">
            <div className="flex flex-col justify-center items-center lg:mt-10">
                ...
                <p className="mt-2 font-semibold text-lg md:text-2xl">Join us and be the one of 150M happy users.</p>
                <p className="text-xl lg:px-10 md:px-4 mt-2 px-5">
